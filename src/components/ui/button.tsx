  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-[var(--shadow-soft)] hover:-translate-y-0.5 hover:opacity-95",
        timerStart:
          "bg-accent text-accent-foreground shadow-[var(--shadow-soft)] hover:-translate-y-0.5 hover:opacity-95",
        timerStop:
          "bg-secondary text-secondary-foreground border border-border shadow-[var(--shadow-soft)] hover:-translate-y-0.5 hover:bg-muted",
      },
      size: {
